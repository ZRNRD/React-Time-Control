...
export const Timer = ({isButtonsBlocked, toggleIsButtonsBlocked}:any) => {
    ...
    <div className={style["timer"]}>
        ...
        <div className={isAlarm ? style["timer__alarm-show"] : style["timer__alarm"]}>
            ...
            <input type="button" className={style["timer__alarm-stop"]} value="ОСТАНОВИТЬ" onClick={() => toggleIsAlarm(false)}></input>
        </div>
        ...
        ?<div className={style["timer__buttons"]}>
            <input type="button" className={style["timer__cancel"]} value="СБРОС" 
                onClick={()=>{toggleIsTimerStarted(false); toggleIsButtonsBlocked(false);}}></input>
            <input type="button" className={style["timer__pause"]} value="ПАУЗА"></input>
        </div>
        :<div className={style["timer__buttons"]}>
            <input type="button" className={style["timer__start"]} value="ПУСК" 
            onClick={()=>{toggleIsTimerStarted(true); toggleIsButtonsBlocked(true);}}></input>
        </div>}
    </div>
    );
}
